...
const SECTIONS: SpecSection[] = [
  ...
  },
  {
    ...
    tips: [
      ...
      "Category 'Senior Teacher' maps to the 'teacher' portal role; 'Assistant' maps to the 'assistant' role — both have the same permissions.",
  ...
  },
  {
    ...
    overview:
      "User Management shows all portal accounts. Teacher and Assistant accounts are created automatically when you add staff in Staff Management — you do not create them here. This page is primarily used to review account status, view role assignments, and manage admin-level users.",
    steps: [
      { heading: "View all portal users", detail: "The list shows every portal account: Super Admin, any additional Admins, and all Teachers/Assistants. Each row shows name, phone, role, and status." },
      { heading: "Activate / Deactivate", detail: "Toggle a user's status. Inactive users cannot log in but their account and history are preserved." },
      { heading: "Role permissions", detail: "Admin has full access to all portal features. Teacher and Assistant have access to: Courses & Classes, Attendance, Weekly Updates, Settings, and Help. Admin-only areas (Dashboard, Announcements, Events, Students, Registration, Inventory, Messaging) are hidden for teachers." },
    ],
    notes: [
      "Teacher portal accounts are created automatically via Staff Management — do not create them manually here.",
      "To reset a teacher's PIN, use the 🔑 Reset PIN button in Staff Management, not this page.",
  ...
  },
  {
    ...
    overview:
      "Weekly Updates are rich posts that teachers publish each week to keep parents informed about class activities, homework, upcoming topics, and important reminders. Parents read these on the Parent Portal after verifying their membership. The page has two tabs: Weekly Updates (your posts) and Announcements (school-wide notices from Admin).",
    steps: [
      { heading: "Two tabs", detail: "The Weekly Updates page has two tabs. 'Weekly Updates' is where you create and manage your class update posts. 'Announcements' shows the latest school-wide notices published by the Admin — read-only for teachers." },
      { heading: "Create a new update", detail: "Click New Update. Use the cascading dropdowns to select Course → Level → Section. Sections load dynamically once you choose a level — the same cascade used in the Attendance tab." },
      ...
      { heading: "Fill the content sections", detail: "Class Highlights (required): summary of what happened. Topics Covered, Homework (highlighted in yellow on the parent view), Upcoming Plan, Reminders (highlighted in rose). These are optional but strongly recommended." },
      { heading: "Add an attachment", detail: "Paste a link to a Google Doc, YouTube video, or any reference material parents should see." },
    ...
    tips: [
      "The course/level/section dropdowns mirror Attendance exactly — if you see a course in Attendance, you'll see it in Weekly Updates.",
      "High Priority updates show a 🔴 badge on the Parent Portal — reserve for truly urgent notices.",
      "Draft updates are only visible to you and admins in the portal — parents cannot see them.",
  ...
  },
  {
    ...
    notes: [
      ...
      "Phone verification uses the temple membership database — parents must be registered members.",
    ],
    tips: [
      "Publish updates regularly — consistent communication keeps parents engaged.",
      "Use the Messaging Centre to notify parents when new weekly updates are posted.",
